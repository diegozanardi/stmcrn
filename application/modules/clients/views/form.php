            ...
            <div class="col-xs-12 col-sm-8">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            <label for="client_surname" class="col-sm-3 col-form-label">
                        ...
                        <div class="form-group row">
                            <label for="client_vat_id" class="col-sm-3 col-form-label"><?php _trans('vat_id'); ?></label>
                        ...
                        <div class="form-group row">
                            <label for="client_tax_code" class="col-sm-3 col-form-label"><?php _trans('tax_code'); ?></label>
                            ...
                            <div class="form-group row">
                                <label for="client_address_1" class="col-sm-3 col-form-label"><?php _trans('street_address'); ?></label>
                            ...
                            <div class="form-group row">
                                <label for="client_city" class="col-sm-3 col-form-label"><?php _trans('city'); ?></label>
                            ...
                            <div class="form-group row">
                                <label for="client_zip" class="col-sm-3 col-form-label"><?php _trans('zip_code'); ?></label>
                            ...
                            <div class="form-group row">
                                <label for="client_phone" class="col-sm-3 col-form-label"><?php _trans('phone_number'); ?></label>
                            ...
                            <div class="form-group row">
                                <label for="client_fax" class="col-sm-3 col-form-label"><?php _trans('fax_number'); ?></label>
                            ...
                            <div class="form-group row">
                                <label for="client_mobile" class="col-sm-3 col-form-label"><?php _trans('mobile_number'); ?></label>
                            ...
                            <div class="form-group row">
                                <label for="client_email" class="col-sm-3 col-form-label"><?php _trans('email_address'); ?></label>
                            ...
                            <div class="form-group row">
                                <label for="client_web" class="col-sm-3 col-form-label"><?php _trans('web_address'); ?></label>
